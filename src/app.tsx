...
import { BASIC_AUTHENTICATION_CREDS, GITHUB_USER_URL } from './configs';
...
const MainComponent = () => {
  ...
  return (<>
    ...
    <FloatButton tooltip='Projects..' onClick={fetchGithubDetails} />
...
const UtilsComponent = () => {
  ...
  useEffect(() => {
    ...
    fetchJson(GITHUB_USER_URL, { headers })
